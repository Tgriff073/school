...
class queue  {
  ...
  private:
  // Data members are:
    vector<el_t> el; // a vector called el.
  ...
  public:    // prototypes to be used by the client
    ...
    //  class exceptions
   class Overflow{};//exception for when the queue is overflowing(full)
   class Underflow{};//exception for when the queue is underflowing(empty)
   // constructor 
   queue(); 
